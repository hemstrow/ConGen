...
```
We can then run `plot_structure()`. This might take a few minutes! If it seems like it is taking too long, you can hit the red STOP button in the upper right hand side of your console to stop the run. The instructor has prepared pre-run results for you if needed. They are located at `Data/monarch_non_strict_structure.RDS`.
